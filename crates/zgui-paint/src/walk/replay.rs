...
impl PaintCache {
    ...
    ///
    /// The replay changes nothing about the record: the chunk was captured before the cull, so
    /// what a position's clip refuses of it is refused again at the next selection rather than
    /// lost.
